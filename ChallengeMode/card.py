import pygame
import image
from normal_settings import CARD_SIZES
...
class Card(pygame.sprite.Sprite):
    def __init__(self, card_type):
        super().__init__()
        # load imgs
        self.card_fire = image.load("NormalAssets/scroll_bar/card_fire.png", size=CARD_SIZES)
        self.card_golden = image.load("NormalAssets/scroll_bar/card_golden.png", size=CARD_SIZES)
        self.card_ice = image.load("NormalAssets/scroll_bar/card_ice.png", size=CARD_SIZES)
        self.card_ground = image.load("NormalAssets/scroll_bar/card_ground.png", size=CARD_SIZES)
        # card elements
        self.type = card_type
