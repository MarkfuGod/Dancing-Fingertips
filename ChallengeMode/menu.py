...
class Menu:
    ...
    def update(self):
        ...
        if ui.button(self.surface, pos_y=200+BUTTONS_SIZES[1]*3, text="Records", click_sound=self.click_sound):
            return "records"
        
        if ui.button(self.surface, pos_y=200+BUTTONS_SIZES[1]*4.5, text="Quit", click_sound=self.click_sound):
            pygame.quit()
            sys.exit()
